...
class AttendanceUpdateAPI(http.Controller):
    ...
    def attendance_update(self, **kwargs):
        ...
        return {
            ...
            'employee_name' : attendance.employee_name.name,
            'employee_code' : attendance.employee_name.employee_code,
            'bu_name' : attendance.employee_name.bu_name.name,
            'department' : attendance.employee_name.department.name,
